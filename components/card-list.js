    ...
    render() {
        ...
        return (
            <CardBox>
                ...
                <TextInput placeholder='Card name' value={card.title} onChangeText={value => editCard(index, 'title', value)}/>
                <TextInput placeholder='Answer' value={card.answer} onChangeText={value => editCard(index, 'answer', value)}/>
            </CardBox>
        )
    }
}
    ...
    render() {
        ...
        return (
            <View style={{width: '100%', alignItems: 'center'}}>
                ...
                <FlatList
                    data={cards}
                    renderItem={({item, index}) => <Card card={item} index={index} deleteCard={deleteCard} editCard={editCard}/>}
                />
            </View>
        )
    }
